...
1. [`docs/00_BRIEF.md`](https://github.com/Kriptic-open-coms/Kriptic/blob/master/docs/00_BRIEF.md) — the project brief: problem, users, principles, success criteria
2. [`docs/01_ARCHITECTURE.md`](https://github.com/Kriptic-open-coms/Kriptic/blob/master/docs/01_ARCHITECTURE.md) — what we're building on top of (fork of bitchat-android) and why
3. [`docs/02_PROJECT_STRUCTURE.md`](https://github.com/Kriptic-open-coms/Kriptic/blob/master/docs/02_PROJECT_STRUCTURE.md) — the monorepo layout
4. [`docs/03_SCOPE.md`](https://github.com/Kriptic-open-coms/Kriptic/blob/master/docs/03_SCOPE.md) — explicit build / don't-build-yet list for v1
5. [`docs/04_DESIGN_SYSTEM.md`](https://github.com/Kriptic-open-coms/Kriptic/blob/master/docs/04_DESIGN_SYSTEM.md) — the visual language
6. [`docs/05_ROADMAP.md`](https://github.com/Kriptic-open-coms/Kriptic/blob/master/docs/05_ROADMAP.md) — v1 → v2 → v3 milestones
7. [`docs/06_THIRD_PARTY.md`](https://github.com/Kriptic-open-coms/Kriptic/blob/master/docs/06_THIRD_PARTY.md) — every open-source project we build on, fork, or reference, and why
8. [`CONTRIBUTING.md`](https://github.com/Kriptic-open-coms/Kriptic/blob/master/CONTRIBUTING.md) — how to get set up and send a PR
9. [`CODE_OF_CONDUCT.md`](https://github.com/Kriptic-open-coms/Kriptic/blob/master/CODE_OF_CONDUCT.md)
