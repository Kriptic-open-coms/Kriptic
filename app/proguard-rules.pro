...
-keep class com.kriptic.app.protocol.** { *; }
-keep class com.kriptic.app.crypto.** { *; }
-dontwarn org.bouncycastle.**
-keep class org.bouncycastle.** { *; }

# Keep SecureIdentityStateManager from being obfuscated to prevent reflection issues
-keep class com.kriptic.app.identity.SecureIdentityStateManager {
    private android.content.SharedPreferences prefs;
    *;
}

# Keep all classes that might use reflection
-keep class com.kriptic.app.favorites.** { *; }
-keep class com.kriptic.app.nostr.** { *; }
-keep class com.kriptic.app.identity.** { *; }

# Keep Tor implementation (always included)
-keep class com.kriptic.app.net.RealTorProvider { *; }
