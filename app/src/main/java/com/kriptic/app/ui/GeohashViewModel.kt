...
import com.kriptic.app.nostr.GeohashMessageHandler
import com.kriptic.app.nostr.GeohashRepository
import com.kriptic.app.nostr.NostrDirectMessageHandler
import com.kriptic.app.nostr.NostrIdentityBridge
import com.kriptic.app.nostr.NostrProtocol
import com.kriptic.app.nostr.NostrRelayManager
import com.kriptic.app.nostr.NostrSubscriptionManager
import com.kriptic.app.nostr.PoWPreferenceManager
import com.kriptic.app.nostr.GeohashAliasRegistry
import com.kriptic.app.nostr.GeohashConversationRegistry
...
class GeohashViewModel(
    ...
    private var locationChannelManager: com.kriptic.app.geohash.LocationChannelManager? = null
    ...
    fun initialize() {
        ...
        try {
            locationChannelManager = com.kriptic.app.geohash.LocationChannelManager.getInstance(getApplication())
            ...
            state.setSelectedLocationChannel(com.kriptic.app.geohash.ChannelID.Mesh)
    ...
    fun sendGeohashMessage(content: String, channel: com.kriptic.app.geohash.GeohashChannel, myPeerID: String, nickname: String?) {
        viewModelScope.launch {
            try {
                ...
                val localMsg = com.kriptic.app.model.BitchatMessage(
                    id = tempId,
                ...
                if (startedMining) {
                    com.kriptic.app.ui.PoWMiningTracker.startMiningMessage(tempId)
                }
                try {
                    ...
                    if (startedMining) {
                        com.kriptic.app.ui.PoWMiningTracker.stopMiningMessage(tempId)
                    }
                }
            } catch (e: Exception) {
    ...
    fun startGeohashDM(pubkeyHex: String, onStartPrivateChat: (String) -> Unit) {
        ...
        val gh = (current as? com.kriptic.app.geohash.ChannelID.Location)?.channel?.geohash
        if (!gh.isNullOrEmpty()) {
    ...
    fun blockUserInGeohash(targetNickname: String) {
        ...
        if (pubkey != null) {
            ...
            val sysMsg = com.kriptic.app.model.BitchatMessage(
                sender = "system",
    ...
    private fun switchLocationChannel(channel: com.kriptic.app.geohash.ChannelID?) {
        ...
        when (channel) {
            is com.kriptic.app.geohash.ChannelID.Mesh -> {
            ...
            is com.kriptic.app.geohash.ChannelID.Location -> {
