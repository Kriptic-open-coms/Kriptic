...
import com.kriptic.app.favorites.FavoritesPersistenceService
import kotlinx.coroutines.flow.StateFlow
import kotlinx.coroutines.flow.MutableStateFlow
import kotlinx.coroutines.flow.asStateFlow
import com.kriptic.app.mesh.BluetoothMeshDelegate
import com.kriptic.app.mesh.BluetoothMeshService
import com.kriptic.app.mesh.MeshService
import com.kriptic.app.service.MeshServiceHolder
import com.kriptic.app.model.BitchatMessage
import com.kriptic.app.model.BitchatMessageType
import com.kriptic.app.nostr.NostrIdentityBridge
import com.kriptic.app.protocol.BitchatPacket


import kotlinx.coroutines.launch
import com.kriptic.app.util.NotificationIntervalManager
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch
import java.util.Date
import kotlin.random.Random
import com.kriptic.app.services.VerificationService
import com.kriptic.app.identity.SecureIdentityStateManager
import com.kriptic.app.noise.NoiseSession
import com.kriptic.app.nostr.GeohashAliasRegistry
import com.kriptic.app.util.dataFromHexString
import com.kriptic.app.util.hexEncodedString
...
class ChatViewModel(
    ...
    val selectedLocationChannel: StateFlow<com.kriptic.app.geohash.ChannelID?> = state.selectedLocationChannel
    ...
    fun getMeshPeerInfo(peerID: String): com.kriptic.app.mesh.PeerInfo? = mesh.getPeerInfo(peerID)
    ...
    init {
        ...
        viewModelScope.launch {
            try { com.kriptic.app.services.AppStateStore.peers.collect { peers ->
                state.setConnectedPeers(peers)
                state.setIsConnected(peers.isNotEmpty())
            } } catch (_: Exception) { }
        }
        viewModelScope.launch {
            try { com.kriptic.app.services.AppStateStore.publicMessages.collect { msgs ->
                // Source of truth is AppStateStore; replace to avoid duplicate keys in LazyColumn
                state.setMessages(msgs)
            } } catch (_: Exception) { }
        }
        viewModelScope.launch {
            try { com.kriptic.app.services.AppStateStore.privateMessages.collect { byPeer ->
                ...
                try {
                    val seen = com.kriptic.app.services.SeenMessageStore.getInstance(getApplication())
        ...
        viewModelScope.launch {
            try { com.kriptic.app.services.AppStateStore.channelMessages.collect { byChannel ->
                // Replace with store snapshot
        ...
        viewModelScope.launch {
            com.kriptic.app.mesh.TransferProgressManager.events.collect { evt ->
    ...
    private fun loadAndInitialize() {
        ...
        viewModelScope.launch {
            com.kriptic.app.ui.debug.DebugSettingsManager.getInstance().debugMessages.collect { msgs ->
                if (com.kriptic.app.ui.debug.DebugSettingsManager.getInstance().verboseLoggingEnabled.value) {
                    ...
                    if (selectedLocation is com.kriptic.app.geohash.ChannelID.Mesh) {
        ...
        com.kriptic.app.favorites.FavoritesPersistenceService.initialize(getApplication())
        ...
        try {
            val nostrTransport = com.kriptic.app.nostr.NostrTransport.getInstance(getApplication())
    ...
    private fun ensureGeohashDMSubscriptionIfNeeded(convKey: String) {
        try {
            ...
            val repo = repoField.get(geohashViewModel) as com.kriptic.app.nostr.GeohashRepository
            ...
            if (!gh.isNullOrEmpty()) {
                ...
                val subMgr = subMgrField.get(geohashViewModel) as com.kriptic.app.nostr.NostrSubscriptionManager
                val identity = com.kriptic.app.nostr.NostrIdentityBridge.deriveIdentity(gh, getApplication())
                val subId = "geo-dm-$gh"
                ...
                if (currentId != subId) {
                    ...
                    subMgr.subscribeGiftWraps(
                        ...
                        handler = { event ->
                            ...
                            val dmHandler = dmHandlerField.get(geohashViewModel) as com.kriptic.app.nostr.NostrDirectMessageHandler
    ...
    fun openLatestUnreadPrivateChat() {
        try {
            ...
            val openPeer: String = if (targetKey.startsWith("nostr_")) {
                ...
                val canonical = com.kriptic.app.services.ConversationAliasResolver.resolveCanonicalPeerID(
                    ...
                    nostrPubHexForAlias = { alias -> com.kriptic.app.nostr.GeohashAliasRegistry.get(alias) },
                    findNoiseKeyForNostr = { key -> com.kriptic.app.favorites.FavoritesPersistenceService.shared.findNoiseKey(key) }
                )
                canonical ?: targetKey
            }
    ...
    fun sendMessage(content: String) {
        ...
        if (content.startsWith("/")) {
            ...
            commandProcessor.processCommand(content, mesh, mesh.myPeerID, { messageContent, mentions, channel ->
                if (selectedLocationForCommand is com.kriptic.app.geohash.ChannelID.Location) {
        ...
        if (selectedPeer != null) {
            ...
            selectedPeer = com.kriptic.app.services.ConversationAliasResolver.resolveCanonicalPeerID(
            ...
            privateChatManager.sendPrivateMessage(
                ...
                val router = com.kriptic.app.services.MessageRouter.getInstance(getApplication(), mesh)
                router.sendPrivate(messageContent, peerID, recipientNicknameParam, messageId)
            }
        } else {
            // Check if we're in a location channel
            val selectedLocationChannel = state.selectedLocationChannel.value
            if (selectedLocationChannel is com.kriptic.app.geohash.ChannelID.Location) {
    ...
    fun toggleFavorite(peerID: String) {
        ...
        try {
            ...
            if (peerInfo?.noisePublicKey != null) {
                ...
                if (peerID.length == 64 && peerID.matches(Regex("^[0-9a-fA-F]+$"))) {
                    try {
                        ...
                        val rel = com.kriptic.app.favorites.FavoritesPersistenceService.shared.getFavoriteStatus(noiseKey!!)
            ...
            if (noiseKey != null) {
                ...
                val identityManager = com.kriptic.app.identity.SecureIdentityStateManager(getApplication())
                ...
                com.kriptic.app.favorites.FavoritesPersistenceService.shared.updateFavoriteStatus(
                ...
                try {
                    com.kriptic.app.services.MessageRouter
    ...
    fun panicClearAllData() {
        ...
        try {
            com.kriptic.app.services.SeenMessageStore.getInstance(getApplication()).clear()
        } catch (_: Exception) { }
        ...
        com.kriptic.app.features.file.FileUtils.clearAllMedia(getApplication())

        // Kriptic: clear marker cache + locked username (see security/PanicWipeManager.kt)
        com.kriptic.app.security.PanicWipeManager.wipeKripticState(getApplication())
        ...
        try {
            ...
            try {
                val store = com.kriptic.app.geohash.GeohashBookmarksStore.getInstance(getApplication())
                store.clearAll()
            } catch (_: Exception) { }

            try {
                val locationManager = com.kriptic.app.geohash.LocationChannelManager.getInstance(getApplication())
    ...
    fun selectLocationChannel(channel: com.kriptic.app.geohash.ChannelID) {
