package com.kriptic.app.features.file
...
object FileUtils {
    ...
    fun saveIncomingFile(
        context: Context,
        file: com.kriptic.app.model.BitchatFilePacket
    ): String {
     ...
     */
    fun messageTypeForMime(mime: String): com.kriptic.app.model.BitchatMessageType {
        val lower = mime.lowercase()
        return when {
            lower.startsWith("image/") -> com.kriptic.app.model.BitchatMessageType.Image
            lower.startsWith("audio/") -> com.kriptic.app.model.BitchatMessageType.Audio
            else -> com.kriptic.app.model.BitchatMessageType.File
        }
    }
