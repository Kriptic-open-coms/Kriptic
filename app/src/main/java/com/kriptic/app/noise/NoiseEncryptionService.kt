package com.kriptic.app.noise

import android.content.Context
import android.util.Log
import com.kriptic.app.identity.SecureIdentityStateManager
import com.kriptic.app.mesh.PeerFingerprintManager
import com.kriptic.app.noise.southernstorm.protocol.Noise
...
class NoiseEncryptionService(private val context: Context) {
    ...
    companion object {
        ...
        private const val REKEY_TIME_LIMIT = com.kriptic.app.util.AppConstants.Noise.REKEY_TIME_LIMIT_MS // 1 hour (same as iOS)
        private const val REKEY_MESSAGE_LIMIT = com.kriptic.app.util.AppConstants.Noise.REKEY_MESSAGE_LIMIT_ENCRYPTION // 1k messages (matches iOS) (same as iOS)
    }
     ...
     */
    fun signPacket(packet: com.kriptic.app.protocol.BitchatPacket): com.kriptic.app.protocol.BitchatPacket? {
     ...
     */
    fun verifyPacketSignature(packet: com.kriptic.app.protocol.BitchatPacket, publicKey: ByteArray): Boolean {
